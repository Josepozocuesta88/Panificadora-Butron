                            ...
                            <li class="dropdown">
                                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown"
                                    ...
                                    <span class="account-user-avatar">
                                        ...
                                        <i
                                            class="bi bi-person-circle font-25
                            ...
                            <li class="side-nav-item">
                                ...
                                <div class="collapse" id="gestion">
                                    <ul class="side-nav-second-level">
                                        ...
                                        <li>
                                            <a
                                                href="{{ route('get.documentos', ['doctip' => 'Albaranes']) }}">Albaranes</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <div aria-live="polite" aria-atomic="true" class="p-3">
                                <div class="toast show help-box m-0 p-0">
                                    <div class="toast-header">
                                        <h5 class="text-dark m-0"><i
                                                class="mdi mdi-gift-open font-22 pe-1"></i>{{ config('app.points') }}</h5>
                                        <button type="button" class="btn-close float-end me-2 m-auto text-white"
                                    ...
                                    <div class="toast-body text-white text-center">
                                        <p class="mb-3">Acumula puntos por tus compras para recibir descuentos y otras
                                            ventajas</p>
                                        <a href="{{ route('all.points') }}"
                                            class="btn btn-warning btn-sm text-dark fw-bolder">Ver mis
                                            puntos</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            @isset($representante)
                                <div class="show help-box bg-white p-1">
                                    <div class="text-dark">
                                        ...
                                        <a
                                            href="https://wa.me/{{ str_replace(' ', '', $representante->rprtel) }}">{{ $representante->rprtel }}</a>
                                    </div>
                                </div>
                            @endisset

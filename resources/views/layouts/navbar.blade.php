      ...
      <div class="app-search dropdown d-none d-lg-block">
        <form method="GET" action="{{ route('search') }}">
          <div class="input-group">
            <input type="search" class="form-control dropdown-toggle" placeholder="Buscar articulos..." id="top-search"
              name="query">
    ...
    <ul class="gap-3 topbar-menu d-flex align-items-center">
      ...
      <li class="dropdown notification-list">
        ...
        <div class="py-0 dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg">
          ...
          <!-- All-->
          <a href="{{ route('cart.show') }}" class="py-2 text-center dropdown-item text-primary notify-item border-top">
            Ir a la cesta
          </a>
      ...
      @auth
      <li class="dropdown">
        <a class="px-2 nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#" role="button"
          aria-haspopup="false" aria-expanded="false">
        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
          ...
          @if(Auth::user()->usugrucod === 'SA')
          <a href="{{ route('settings.email') }}" class="dropdown-item" id="clear-database">
            <i class="mdi mdi-email-outline me-1"></i>
            <span>Gestión de Correo</span>
          </a>
          @endif

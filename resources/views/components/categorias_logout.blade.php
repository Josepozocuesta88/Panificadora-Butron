    ...
    <div id="categorias" class="categorias scrollbar gap-2">
        ...
        <div class="categoria col-6 col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="nombre-categoria bg-primary text-center">
                <h5>
                    <a href="{{route('categoriesNoLogin', ['catcod' => $category->catcod])}}" class="text-white" onclick="irAProductos()"> {{ $category->catnom }} </a>
                </h5>
                <a href="{{route('categoriesNoLogin', ['catcod' => $category->catcod])}}" onclick="irAProductos()" class="categoria-link text-warning font-20"> Ver más

          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <a href="javascript:void(0);" class="text-center d-block mb-4" data-bs-toggle="modal"
                ...
                <img src="{{ asset('images/articulos/' . $articulo->primeraImagen()) }}" class="img-fluid"
                  style="max-width: 280px;" alt="Product-img" id="mainImage"
              ...
              <div class="d-lg-flex d-none justify-content-center">
                ...
                <a href="javascript: void(0);">
                  <img src="{{ asset('images/articulos/' . $imagen->imanom) }}" class="img-fluid img-thumbnail p-2"
              ...
              <form method="POST" action="{{ route('cart.add', ['artcod' => $articulo->artcod]) }}" class="ps-lg-4">
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <div class="d-flex gap-4">
                      ...
                      <div class="product-price">
                        ...
                        @else
                        <h3> {{ \App\Services\FormatoNumeroService::convertirADecimal($articulo->precioTarifa *
                          $caja->cajreldir) }}
                          €</h3>
                        @endif
                    ...
                    <div class="form-check">
                      ...
                      @foreach($cajas as $index => $caja)
                      <div>
                        <input class="form-check-input" type="radio" value="{{ $caja->cajcod }}" name="input-tipo"
                          id="caja{{ $index }}" @if($caja->cajdef == 1)
                        checked
                        @endif
                        >
                  ...
                  <div class="col text-end">
                    ...
                    <p class="mb-0"><img src="{{ asset('images/alergenos/'. $alergeno . '.ico') }}" alt=""></p>
                    @endforeach
                    @endisset
                  </div>
                  <!-- fin alergenos -->
                ...
                <div class="mt-3">
                  ...
                  <div class="d-flex align-items-end mt-3">
                    ...
                    <button type="submit" class="btn btn-danger ms-2"><i class="mdi mdi-cart me-1"></i> Añadir al
                      carrito</button>
                  </div>
                </div>

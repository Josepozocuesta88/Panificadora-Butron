                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <img src="{{ asset('images/articulos/' . $item['image']) }}"
                                                            alt="img" class="rounded me-2 tw-h-12" height="48" />
                                                        @else
                                                        <img src="{{ asset('images/articulos/noimage.jpg') }}" alt="img"
                                                            class="rounded me-2 tw-h-12" height="48" />
                                                        @endif

                                                        <p class="m-0 align-middle d-inline-block text-truncate"
                                                ...
                                                <td class="pe-0">
                                                    <div class="d-flex align-items-center justify-content-start">
                                                        <input type="number" class="form-control me-1" disabled
                                                            ...
                                                            style="width:90px;">
                                                        <label for="unit-quantity-input" class="mb-0 quantity-update">{{
                                                            $item['promedcod'] }}</label>
                                                    </div>
                                                </td>
                                                @endif
                                                <!-- precio -->
                                ...
                                <div class="mt-5">
                                    ...
                                    <div id="direcciones" class="row">
                                        ...
                                        <div class="mb-1 col-11 col-md-5 col-lg-4">
                                            <div class="card direccion-card {{ $loop->first ? 'selected' : '' }}"
                                                data-direccion-id="{{ $direccion->dirid }}">
                                                <div class="card-body">
                                                    <p class="card-text">
                                                        ...
                                                        {{ $direccion->dirpob }}<br>
                                                        <strong>País:</strong> {{ $direccion->dirpai }}<br>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-end">
                                            ...
                                            <button class="btn btn-danger" id="procesarPedido">
                                                <i class="mdi mdi-cart-plus me-1"></i> Procesar el pedido </button>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row-->
                            </div>
